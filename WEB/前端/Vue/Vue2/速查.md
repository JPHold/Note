...
| [[#表单输入绑定（双向绑定）]]：[原文](https://cn.vuejs.org/v2/guide/forms.html)                                                                                                                        | 所有用到这个变量，都会同时响应。<br/><br/>支持text、textarea、radio、checkbox等                                                                                                                                                                                                                                  |                                                                                                                                          |     |
| [[#生命周期]]                                                                                                                                                                                          |                                                                                                                                                                                                                                                                                                        |                                                                                                                                          |     |
| [[#组件基础]]                                                                                                                                                                                          | 组件的取名：`-`分隔、驼峰; <br/><br/>跟vue实例拥有差不多属性和方法：`data`、`computed`、`watch`、`methods` 以及生命周期钩子（除了el属性）<br/><br/>[[#局部组件]]<br/><br/>[[#伪全局组件#特性]]                                                                                                                                                                                                                                           | 这种组件编写方式，写模板时，不好写，而且对于很长的组件编写，会很丑；<br/><br/>不能写css <br/><br/>data是个函数而不是对象，是为了保证组件复用时，属性不会冲突                                                      |     |
