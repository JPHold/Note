...
| [透传属性和事件](https://cn.vuejs.org/guide/components/attrs.html) |<br>1. 不用通过defineEmit和defineProps声明，即可使用的事件和属性，也就是原生事件和原生属性<br>2. 支持style、class、id等原生属性，style和class会合并，id不会<br>3. 支持click等原生事件，  |
