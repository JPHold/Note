...
| 组件基础 | <br>1.  [Web Component的联系](https://cn.vuejs.org/guide/extras/web-components.html)<br>2.  `script`、`template`、`style`三种标签定义SFC|
