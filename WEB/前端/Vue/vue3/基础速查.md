...
| [计算属性：computed](https://cn.vuejs.org/guide/essentials/computed.html)                                                                                                     | <br>1. 根据被计算的属性值，生成新值，而且是响应式的；<br>2. 缓存特性：被计算的属性值未变则不会重新计算，而方法是每次渲染都重新计算<br>[[#计算属性]]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |     |     |
