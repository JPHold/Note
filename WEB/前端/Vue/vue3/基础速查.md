...
| [模板引用：ref函数和ref属性](https://cn.vuejs.org/guide/essentials/template-refs.html#function-refs) | <br>1. 获取html元素，手动修改dom的情况。用ref函数创建响应式变量，然后在html元素指定ref属性值为该变量名。<br>2. [[#使用侦听器监听DOM变化]]（需要判断空，因为挂载后才会产生DOM）<br>[[#模板引用]]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
