...
| publish | 过滤发布到主机的端口 | (官方的例子还是错的。。。)[[Docker重点]][[#^396cbc]]，所以就不用官方的例子了。`docker ps -f publish=23331`![[Pasted image 20210801122608.png]] |
| expose | 过滤发布到容器内部的端口 |`docker ps -f expose=6379` ![[Pasted image 20210801122723.png]]|
|  |  |  |
